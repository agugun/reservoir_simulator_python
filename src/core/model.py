...
class ReservoirModel:
    ...
    def __init__(self, grid: Grid, rock: Rock, fluid: Fluid, initial_pressure: np.ndarray, wells: Optional[List[Well]] = None, swat: Optional[np.ndarray] = None, sgas: Optional[np.ndarray] = None, rs: Optional[np.ndarray] = None):
        """
